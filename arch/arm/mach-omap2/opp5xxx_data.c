...
static struct omap_opp_def __initdata omap54xx_es1_opp_def_list[] = {
	...
	/* ABE OPP1 - OPPLOW */
	OPP_INITIALIZER("aess", "abe_clk", "core", true, 983040000, OMAP5430_VDD_CORE_OPP_LOW),
	/* ABE OPP2 - OPPNOM */
	...
	/* IVA OPP1 - OPPLOW */
	OPP_INITIALIZER("iva", "dpll_iva_h12_x2_ck", "mm", true, 194200000, OMAP5430_VDD_MM_OPP_LOW),
	/* IVA OPP2 - OPPNOM */
	OPP_INITIALIZER("iva", "dpll_iva_h12_x2_ck", "mm", true, 388300000, OMAP5430_VDD_MM_OPP_NOM),
	/* IVA OPP3 - OPP-OD */
	OPP_INITIALIZER("iva", "dpll_iva_h12_x2_ck", "mm", false, 532000000, OMAP5430_VDD_MM_OPP_OD),

	/* DSP OPP1 - OPP50 */
	OPP_INITIALIZER("dsp", "dpll_iva_h11_x2_ck", "mm", true, 233000000, OMAP5430_VDD_MM_OPP_LOW),
	/* DSP OPP2 - OPP100 */
	OPP_INITIALIZER("dsp", "dpll_iva_h11_x2_ck", "mm", true, 466000000, OMAP5430_VDD_MM_OPP_NOM),
	/* DSP OPP3 - OPPTB */
	OPP_INITIALIZER("dsp", "dpll_iva_h11_x2_ck", "mm", false, 432000000, OMAP5430_VDD_MM_OPP_OD),
#endif
#if 0
	/* SGX OPP1 - OPPLOW */
	OPP_INITIALIZER("gpu", "dpll_per_h14_x2_ck", "mm", true, 192000000, OMAP5430_VDD_MM_OPP_LOW),
	/* SGX OPP2 - OPPNOM */
	OPP_INITIALIZER("gpu", "dpll_per_h14_x2_ck", "mm", true, 384000000, OMAP5430_VDD_MM_OPP_NOM),
	/* SGX OPP3 - OPPOV */
	OPP_INITIALIZER("gpu", "dpll_per_h14_x2_ck", "mm", true, 512000000, OMAP5430_VDD_MM_OPP_OD),
#endif
};

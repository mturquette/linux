			...
			const struct mpu6050_data *mpu_data)
{
	...
	MPU6050_WRITE(accel_data, MPU6050_CHIP_I2C_ADDR, MPU6050_REG_INT_ENABLE,
			(intr_mask | MPU6050_DATARDY_INT) , "Enable Intr");
	/* Clear interrupts for Defined mode */
	MPU6050_READ(accel_data, MPU6050_CHIP_I2C_ADDR, MPU6050_REG_INT_STATUS,
						1, &val, "Clear Isr");
	return accel_data;
